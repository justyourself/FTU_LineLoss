...
const EVTPARALIST s_PnEvt[] =
{
  CH0_PAN_EVT_PT,CH0_PAN_EVT_ADDR,
  CH0_PBN_EVT_PT,CH0_PBN_EVT_ADDR,
  CH0_PCN_EVT_PT,CH0_PCN_EVT_ADDR,
  CH1_PAN_EVT_PT,CH1_PAN_EVT_ADDR,
  CH1_PBN_EVT_PT,CH1_PBN_EVT_ADDR,
  CH1_PCN_EVT_PT,CH1_PCN_EVT_ADDR,
  CH2_PAN_EVT_PT,CH2_PAN_EVT_ADDR,
  CH2_PBN_EVT_PT,CH2_PBN_EVT_ADDR,
  CH2_PCN_EVT_PT,CH2_PCN_EVT_ADDR,
  CH3_PAN_EVT_PT,CH3_PAN_EVT_ADDR,
  CH3_PBN_EVT_PT,CH3_PBN_EVT_ADDR,
  CH3_PCN_EVT_PT,CH3_PCN_EVT_ADDR,
  CH4_PAN_EVT_PT,CH4_PAN_EVT_ADDR,
  CH4_PBN_EVT_PT,CH4_PBN_EVT_ADDR,
  CH4_PCN_EVT_PT,CH4_PCN_EVT_ADDR,
  CH5_PAN_EVT_PT,CH5_PAN_EVT_ADDR,
  CH5_PBN_EVT_PT,CH5_PBN_EVT_ADDR,
  CH5_PCN_EVT_PT,CH5_PCN_EVT_ADDR,
  CH6_PAN_EVT_PT,CH6_PAN_EVT_ADDR,
  CH6_PBN_EVT_PT,CH6_PBN_EVT_ADDR,
  CH6_PCN_EVT_PT,CH6_PCN_EVT_ADDR,
  CH7_PAN_EVT_PT,CH7_PAN_EVT_ADDR,
  CH7_PBN_EVT_PT,CH7_PBN_EVT_ADDR,
  CH7_PCN_EVT_PT,CH7_PCN_EVT_ADDR,
};

const EVTPARALIST s_PtEvt[] =
{
  CH0_PTD_EVT_PT,CH0_PTD_EVT_ADDR,
  CH1_PTD_EVT_PT,CH1_PTD_EVT_ADDR,
  CH2_PTD_EVT_PT,CH2_PTD_EVT_ADDR,
  CH3_PTD_EVT_PT,CH3_PTD_EVT_ADDR,
  CH4_PTD_EVT_PT,CH4_PTD_EVT_ADDR,
  CH5_PTD_EVT_PT,CH5_PTD_EVT_ADDR,
  CH6_PTD_EVT_PT,CH6_PTD_EVT_ADDR,
  CH7_PTD_EVT_PT,CH7_PTD_EVT_ADDR,
};
